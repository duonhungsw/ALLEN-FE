        ...
        >
          ...
          >
            <p className="text-sm" style={{ color: "#6B7280" }}>
              {step.contentJson
                ? step.contentJson.substring(0, 100) + "..."
                : "Nội dung bài học"}
            </p>
          </motion.div>
...
export default function UnitStepsPage({ params }: PageProps) {
  ...
  const questionsCountMap = stepIds.reduce(
    (acc: Record<string, number>, stepId: string, index: number) => {
          ...
          {isLoading ? (
            ...
            >
              ...
              <div className="text-sm" style={{ color: "#6B7280" }}>
                Hãy đợi admin thêm bài học mới
              </div>
            </motion.div>
          )}
        </div>
