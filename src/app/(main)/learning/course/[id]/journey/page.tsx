...
function StepNode({ step, index, isActive, isCompleted, onClick }: StepNodeProps) {
    ...
    return (
        ...
        >
            <motion.div
                className={`w-12 h-12 rounded-full flex items-center justify-center cursor-pointer border-2 shadow-lg ${isActive
            ...
            >
                <p className="text-xs font-medium" style={{ color: isActive ? '#F3713B' : '#6B7280' }}>
                    {step?.title || 'Untitled'}
                </p>
...
export default function CourseJourneyPage({ params }: PageProps) {
    ...
    return (
        <div className="min-h-screen relative" style={{ backgroundColor: '#F5F3EA' }}>
            ...
            <div className="relative z-10">
                ...
                >
                    ...
                    >
                        <h1 className="text-4xl font-bold mb-4" style={{ color: '#142F50' }}>
                ...
                <div className="px-6 pb-8">
                    ...
                    >
                        ...
                        <div className="flex items-center mb-6">
                            <div className="w-8 h-8 rounded-lg flex items-center justify-center mr-3" style={{ backgroundColor: '#F3713B' }}>
                        ...
                        >
                            <p className="text-base" style={{ color: '#6B7280' }}>
                                Đặt nền tảng với từ vựng và các mẫu câu cơ bản để bắt đầu hành trình học ngoại ngữ của bạn.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b" style={{ borderColor: '#E5E7EB' }}>
                            <div className="flex items-center space-x-3">
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#F3713B' }}>
                        ...
                        <div className="p-6">
                            <div className="text-center py-8">
                                ...
                                <h4 className="text-lg font-bold mb-2" style={{ color: '#142F50' }}>
                                    Sẵn sàng bắt đầu?
                                </h4>
                                <p className="text-sm mb-6" style={{ color: '#6B7280' }}>
                                    Bạn sẽ được làm {selectedStep?.title || 'bài học'} với các câu hỏi thú vị
                                </p>
                                <Link href={`/learning/course/${params.id}/step/${selectedStep?.id || ''}`}>
                                    <motion.button
