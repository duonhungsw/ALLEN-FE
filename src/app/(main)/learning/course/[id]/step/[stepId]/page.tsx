        ...
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#F5F3EA' }}>
                ...
                >
                    ...
                    <div className="text-lg font-bold mb-2" style={{ color: '#142F50' }}>Chưa có câu hỏi</div>
                    <div className="text-sm" style={{ color: '#6B7280' }}>Hãy đợi admin thêm câu hỏi mới</div>
                </motion.div>
            </div>
        );
    }
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-lg font-bold" style={{ color: timeLeft <= 10 ? '#EF4444' : '#142F50' }}>
                                {timeLeft}s
                            </span>
                        </div>
            ...
            <div className="max-w-4xl mx-auto px-6 py-8">
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 0.3, delay: 0.2 }}
                        >
                            <h2 className="text-2xl font-bold mb-4" style={{ color: '#142F50' }}>
                ...
                {score.total > 0 && (
                    <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                    >
                        <h3 className="text-lg font-bold mb-4" style={{ color: '#142F50' }}>Kết quả</h3>
                        <div className="grid grid-cols-3 gap-4 text-center">
                            <div>
                                <div className="text-2xl font-bold" style={{ color: '#F3713B' }}>{score.correct}</div>
                                <div className="text-sm" style={{ color: '#6B7280' }}>Đúng</div>
                            </div>
                            <div>
                                <div className="text-2xl font-bold" style={{ color: '#142F50' }}>{score.total}</div>
                                <div className="text-sm" style={{ color: '#6B7280' }}>Tổng</div>
                            </div>
                            <div>
                                <div className="text-2xl font-bold" style={{ color: '#F3713B' }}>
