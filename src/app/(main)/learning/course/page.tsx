...
import { LearningUnit } from "@/types/learning/learningType";
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              {learningUnits?.data?.map((unit: LearningUnit, index: number) => (
                ...
                >
                  <Link
                    href={`/learning/course/${unit.id}/journey`}
                    className="h-full block"
                  >
                    <div
                      className="bg-white rounded-lg shadow-sm border p-3 cursor-pointer hover:shadow-md transition-shadow h-full flex flex-col"
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3
                            ...
                            style={{ color: "#142F50" }}
                          >
                            {unit.title.length > 50
                              ? unit.title.substring(0, 50) + "..."
                              : unit.title}
                          </h3>
                              ...
                              style={{
                                backgroundColor:
                                  unit.skillType === "Speaking"
                                    ...
                                    ? "#3B82F6"
                                    : unit.skillType === "Listening"
                                    ? "#8B5CF6"
                                    : unit.skillType === "Writing"
                                    ? "#F59E0B"
                                    : "#6B7280",
                              }}
                            >
