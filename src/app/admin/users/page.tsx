...
export default function UsersManagement() {
    ...
    const { searchInput, searchTerm, setSearchInput, clearSearch } = useDebounceSearch({
        delay: 500,
        onSearch: () => {
            setCurrentPage(1);
        }
        ...
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Select value={statusFilter} onValueChange={setStatusFilter}>
                        <SelectTrigger className="border-[#D2B48C] focus:border-[#8B4513] focus:ring-[#8B4513] text-[#8B4513] font-medium">
                            <SelectValue placeholder="Tất cả trạng thái" className="text-[#A0522D] font-medium" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem value="all" className="text-[#8B4513] font-medium">Tất cả trạng thái</SelectItem>
                            <SelectItem value="active" className="text-[#8B4513] font-medium">Hoạt động</SelectItem>
                            <SelectItem value="banned" className="text-[#8B4513] font-medium">Bị cấm</SelectItem>
                            <SelectItem value="pending" className="text-[#8B4513] font-medium">Chờ duyệt</SelectItem>
                        </SelectContent>
                    </Select>

                    <Select value={roleFilter} onValueChange={setRoleFilter}>
                        <SelectTrigger className="border-[#D2B48C] focus:border-[#8B4513] focus:ring-[#8B4513] text-[#8B4513] font-medium">
                            <SelectValue placeholder="Tất cả vai trò" className="text-[#A0522D] font-medium" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem value="all" className="text-[#8B4513] font-medium">Tất cả vai trò</SelectItem>
                            <SelectItem value="user" className="text-[#8B4513] font-medium">Người dùng</SelectItem>
                            <SelectItem value="premium" className="text-[#8B4513] font-medium">Premium</SelectItem>
                        </SelectContent>
                    </Select>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center space-x-3">
                                            <div className="relative">
                                                ...
                                                <div
                                                    className={`w-10 h-10 rounded-full border-2 border-[#D2B48C] bg-gradient-to-r from-[#8B4513] to-[#A0522D] flex items-center justify-center text-white font-bold text-sm ${user.picture ? 'hidden' : 'flex'}`}
                                                >
            ...
            >
                <div className="text-[#8B4513] text-sm font-medium">
                    Hiển thị {((currentPage - 1) * itemsPerPage) + 1}-{Math.min(currentPage * itemsPerPage, totalCount)} trong tổng số {totalCount} người dùng (7 items/trang)
                </div>
                <div className="flex items-center space-x-2">
                    <Button
                        variant="outline"
