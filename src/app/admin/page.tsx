...
import { Users, Shield, BarChart3, Settings, UserCheck, UserX, Activity } from "lucide-react";
    ...
    return (
        <div className="space-y-8">
                ...
                {adminFeatures.map((feature, index) => (
                    ...
                    >
                        <Link href={feature.href}>
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-[#D2B48C]/30 hover:shadow-xl transition-all duration-300 h-full">
                                ...
                                <h3 className="text-xl font-semibold text-[#8B4513] mb-2 group-hover:text-[#A0522D] transition-colors">
                                    {feature.title}
                                </h3>

                                <p className="text-[#A0522D] mb-4 leading-relaxed">
                                    {feature.description}
                                </p>

                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-[#CD853F] font-medium">
                                        {feature.stats}
                                    </span>
            ...
            <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-[#D2B48C]/30"
            >
                <h2 className="text-2xl font-semibold text-[#8B4513] mb-6">Tổng quan hệ thống</h2>
