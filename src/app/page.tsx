  ...
  if (!hasMounted) {
    return (
      <div className={`relative min-h-screen w-full ${customColors.bodyBg} flex items-center justify-center p-4 transition-colors duration-500`}>
        ...
        <div className="relative z-10 w-full max-w-md p-8 text-center bg-white/70 dark:bg-gray-800/80 backdrop-blur-lg border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl">
          <div className="mb-6">
          ...
          {isLoading ? (
            ...
            <Image
              src={
                userData?.picture
                  ? userData.picture
                  : `https://avatar.vercel.sh/${userData?.name ?? "default"}.svg`
              }
