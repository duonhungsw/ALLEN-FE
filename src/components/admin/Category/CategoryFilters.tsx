    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="flex space-x-2 sm:col-span-2 lg:col-span-1">
          ...
          <Button
            className="bg-[#f3713b] hover:bg-[#A0522D] text-white w-full sm:w-auto text-sm sm:text-base font-calistoga-regular"
            onClick={onResetFilters}
          >
            <Filter className="w-4 h-4 mr-2" />
            <span className="hidden sm:inline ">Reset1</span>
