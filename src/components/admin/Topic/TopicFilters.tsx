            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <Select value={statusFilter} onValueChange={onStatusFilterChange}>
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="draft" className="text-[#8B4513] font-medium font-calistoga-regular">
                            Bản nháp
                        </SelectItem>
                    </SelectContent>
                </Select>
                    ...
                    {selectedTopics.length > 0 && (
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">
                                {isDeleting ? "Đang xóa..." : `Xóa (${selectedTopics.length})`}
                            </span>
                            <span className="sm:hidden">
                                {isDeleting ? "..." : `Xóa ${selectedTopics.length}`}
                            </span>
                        </Button>
                    )}
                    <Button
